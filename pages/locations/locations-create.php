...
if(!empty($_POST["submit"])) {
	...
	$sql = "INSERT INTO tbl_locations VALUES ( :id, :name, :address, :phone, :email )";
	$pdo_statement = $pdo_conn->prepare( $sql );
	$result = $pdo_statement->execute( array( ':id'=>$_POST['id'], ':name'=>$_POST['name'], ':address'=>$_POST['address'], ':phone'=>$_POST['phone'], ':email'=>$_POST['email'] ) );
	print_r($result);
    if($result >= 1 ){
