...
?>
<?php
$pdo_statement = $pdo_conn->prepare("SELECT * FROM employee ORDER BY id DESC");
            ...
            <div class="px-4 sm:px-6 lg:px-8">
                <div class="sm:flex sm:items-center">
                    ...
                    <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none"> <a type="button"
                            ...
                            href="index.php?page=employees-create">Add employees</a> </div>
                </div>
                              ...
                              ?>
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                <a
                                                    href="index.php?page=employees-edit&id=<?php echo $row['id'] ?>">Edit</a>
                                            <td
                                                class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">
                                                <a
                                                    href='index.php?page=employees-delete&id=<?php echo $row['id']; ?>'>Delete</a>
                                            </td>
                                        </tr>
                                        <?php } } ?>
                                        </tr>
