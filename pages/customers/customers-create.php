...
if(!empty($_POST["submit"])) {
	...
	$sql = "INSERT INTO tbl_customers ( person_id, fullname, phone_number, email) VALUES ( :person_id, :fullname, :phone_number, :email)";
	$pdo_statement = $pdo_conn->prepare( $sql );
	$result = $pdo_statement->execute( array( ':person_id'=>$_POST['person_id'], ':fullname'=>$_POST['fullname'], ':phone_number'=>$_POST['phone_number'], ':email'=>$_POST['email'] ) );
	print_r($result);
  if($result >= null ){
...
<form method="POST" class="w-full max-w-3/4 border-collapse border border-slate-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            <a href="index.php?page=item-kits" class="text-2xl font-semibold text-gray-900">Add Customers</a>
        </div>
        <div class="py-6">
