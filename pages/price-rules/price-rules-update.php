...
if(!empty($_POST["update"])) {
	$pdo_statement=$pdo_conn->prepare("update tbl_pricerules set id='" . $_POST[ 'id' ] . "', rule_name='" . $_POST[ 'rule_name' ] . "', start_date='" . $_POST[ 'start_date' ]. "', end_date='" . $_POST[ 'end_date' ]. "', rule_type='" . $_POST[ 'rule_type' ]. "', coupon_code='" . $_POST[ 'coupon_code' ]. "' where id=" . $_GET["id"]);
  $result = $pdo_statement->execute();
  if($result) {
		echo "<script>window.location.href='index.php?page=price-rules'</script>";
	}
}
$pdo_statement = $pdo_conn->prepare("SELECT * FROM tbl_pricerules where id=" . $_GET["id"]);
...
<form method="POST" class="w-full max-w-3/4 border-collapse border border-slate-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            <a class="text-2xl font-semibold text-gray-900">Edit Price Rules</a>
        </div>
        <div class="py-6">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 border-gray-200 rounded-lg h-96">
                <form action="" method="POST">
                    ...
                    <div class="relative z-0 mb-6 w-full group">
                        <input type="text" name="rule_name" value="<?php echo $result[0]['rule_name']; ?>"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    ...
                    <div class="relative z-0 mb-6 w-full group">
                        <input type="date" name="start_date" value="<?php echo $result[0]['start_date']; ?>"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " required>
                    ...
                    <div class="relative z-0 mb-6 w-full group">
                        <input type="date" name="end_date" value="<?php echo $result[0]['end_date']; ?>"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " required>
                        <label for="end_date"
                    ...
                    <div class="relative z-0 mb-6 w-full group">
                        <input type="text" name="rule_type" value="<?php echo $result[0]['rule_type']; ?>"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " required>
                        <label for="rule_type"
                    ...
                    <div class="relative z-0 mb-6 w-full group">
                        <input type="text" name="coupon_code" value="<?php echo $result[0]['coupon_code']; ?>"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " required>
